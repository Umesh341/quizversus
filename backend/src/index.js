...
app.use(cors({
    origin: process.env.MODE === "production" ? process.env.FRONTEND_URL : 'http://localhost:5173', // frontend origin
    credentials: true,
...
const io = new Server(server, {
  cors: {
    origin: process.env.MODE === "production" ? process.env.FRONTEND_URL : "http://localhost:5173",
    credentials: true,
    methods: ["GET", "POST"]
  }
});
